...
class Level5Controller extends \BaseController {
	...
	{
		$l5channels = Level5::all();
		return View::make('level5.index',compact('l5channels'));
	}
	...
	public function import(){
		return View::make('level5.import');
	}

	public function export(){
		$channels = Level5::all();

		Excel::create("Level 5 Channels", function($excel) use($channels){
	...
	public function upload(){
		if(Input::hasFile('file')){
			...
			return Redirect::action('Level5Controller@index')
					->with('class', 'alert-success')
					->with('message', 'Channel list successfuly updated');
		}else{

			return Redirect::action('Level5Controller@import')

			...
			<table class="table table-striped table-condensed table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td></td>
						@endif
						<td class="center">{{ ($activity->pdf) ? '<i class="fa fa-check"></i>' : '' }}</td>
						<td class="center">{{ ($activity->word) ? '<i class="fa fa-check"></i>' : '' }}</td>
						<td class="center">{{ ($activity->disable) ? '<i class="fa fa-check"></i>' : '' }}</td>
						<td class="action">

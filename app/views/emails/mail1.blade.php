...
<body>
	...
	<h1>Hi, {{ $user }}!</h1>
	<p>Sending below summary of activity status as of today. Please take note of the following deadlines.</p>
	<ul>
		@foreach($cycles as $cycle)
		<li>{{ $cycle->cycle_name }} - Submission Deadline: {{ $cycle->submission_deadline }}</li>
		<li>{{ $cycle->cycle_name }} - Approval Deadline: {{ $cycle->approval_deadline }}</li>
		@endforeach
	</ul>

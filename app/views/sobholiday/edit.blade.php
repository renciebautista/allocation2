...
{{ Form::open(array('route' => array('sobholiday.update', $holiday->id), 'method' => 'PUT', 'class' => 'bs-component','id' => 'myform')) }}
<div class="row">
	...
	<div class="col-lg-6">
		...
		<div class="form-group">
			...
			{{ Form::text('desc',$holiday->description ,array('class' => 'form-control', 'placeholder' => 'Description')) }}
		</div>
		<div class="form-group">
			{{ Form::label('date', 'Date', array('class' => 'control-label')) }}
			{{ Form::text('date',date_format(date_create($holiday->date),'m/d/Y'),array('class' => 'form-control', 'placeholder' => 'Date')) }}
		</div>
		...
		<div class="table-responsive">
			<table id="shipto" class="table table-striped table-hover">
				...
				<tbody>
					...
					<tr>
						<td>
							{{ Form::checkbox("shiptos[]", $shipto->ship_to_code,(in_array($shipto->ship_to_code,$selected))? true: false) }}
						</td>

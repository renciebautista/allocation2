...
$('#download_date, #implementation_date').datetimepicker({
	pickTime: false,
	calendarWeeks: true,
	minDate: moment()
});

$('#download_date, #implementation_date').mask("99/99/9999",{placeholder:"mm/dd/yyyy"});
...
$('form#updateActivity').on("submit",function(e){
	// console.log(e);
	var form = $(this);

...
<div class="row">
				...
				<div class="row">
						<div class="col-lg-12">
							<div class="form-group">
								<div class="row">
									<div class="col-lg-12">
										{{ Form::label('circular_name', 'Activity ID Name', array('class' => 'control-label')) }}
	...
	<div class="col-lg-6">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">Select Customers Involved</h3>
			</div>
			<div class="panel-body">
				<div id="tree3"></div>
	...
	<div class="col-lg-6">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h3 class="panel-title">Select DT Channels Involved</h3>
			</div>
			<div class="panel-body">
			<div class="col-lg-12">
				<div class="form-group">

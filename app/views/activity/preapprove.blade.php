...
<div class="page-header" id="banner">
	<div class="row">
	  	<div class="col-lg-8 col-md-7 col-sm-6">
			<h1>Customized Activity Pre Approval List</h1>
	  	</div>
	</div>
</div>
			...
			<table class="table table-striped table-condensed table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						@endif
						<td class="action">
							{{ HTML::linkAction('ActivityController@preapproveedit','View', array('id' => $activity->id), array('class' => 'btn btn-success btn-xs')) }}
						</td>
						<td class="action">
...
@include('javascript.submittedactivity.index')

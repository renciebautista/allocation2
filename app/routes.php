...
Route::get('print', function (){
	...
	// 	$body .='<tr>
	// 			<td style="width:40px;border: 1px solid #000000">'.$scheme_customer->group.'</td>
	// 			<td style="width:120px;border: 1px solid #000000">'.$scheme_customer->area.'</td>
	// 			<td style="width:150px;border: 1px solid #000000">'.$scheme_customer->sold_to.'</td>
	// 			<td style="width:150px;border: 1px solid #000000">'.$scheme_customer->ship_to.'</td>
	// 			<td style="width:60px;border: 1px solid #000000">'.$scheme_customer->channel.'</td>
	// 			<td style="width:200px;border: 1px solid #000000">'.$scheme_customer->outlet.'</td>
	// 		</tr>';
	// }
	$cnt = 0;
	for($i = 0; $i <= $loops; $i++){
